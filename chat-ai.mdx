...
<AccordionGroup>
  ...
  <Accordion title="Calendars" defaultOpen={false} icon="calendar">
    You can sync and connect your GoHighLevel calendars using the calendars tab in the assistant builder. Calendar syncing is down on the backend for you but you are able to refresh the connection using the Sync Calendar button. Once you see your desired calendar and it has been verified, you can add it to your assistant to be used in booking.



    <u>Calendar Verification:</u>
